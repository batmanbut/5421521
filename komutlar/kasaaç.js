...
exports.run = (client, message) => {
    ...
    .setAuthor('RexWare Bot', csgopng)
    .setDescription(`${kasadancikanlar}`)
    .setFooter(`Kasayı açan (${message.author.username}) | Kasa Fiyatı: 710$ | Kasadan çıkan bütün ürünler sizde kalmaz sadece eğlence için yapılmış bir komutdur`)
    .setColor("RANDOM")
